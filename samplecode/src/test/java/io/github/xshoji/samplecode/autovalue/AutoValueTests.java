...
public class AutoValueTests {
  ...
  public void test() {
    ...
    Banana banana =
        Banana.builder().setBrandName("BananaKing").setProductionArea("Japan").setCost(100).build();
    ObjectPrinter.println(banana);
    Banana banana2 = Banana.builder().setProductionArea("America").setCost(200).build();
