...
import jp.gr.javaconf.org.nsgeorge.guicecommandtool.command.*;
...
public class CommandFactory {
    ...
    public void CommandFactory(Injector injector) {
        ...
        List<String> commandClassNames = new FastClasspathScanner("jp.gr.javaconf.org.nsgeorge.guicecommandtool.command")
                .scan()
