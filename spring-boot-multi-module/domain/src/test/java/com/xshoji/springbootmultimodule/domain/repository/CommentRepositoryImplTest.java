...
import com.xshoji.springbootmultimodule.domain.SpringBootMultiModuleApplication;
...
@SpringBootTest(classes = SpringBootMultiModuleApplication.class)
@ComponentScan(basePackages = {"com.xshoji"})
